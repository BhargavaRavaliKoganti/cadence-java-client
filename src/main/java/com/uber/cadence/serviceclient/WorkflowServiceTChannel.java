...
public class WorkflowServiceTChannel implements IWorkflowService {
  ...
  private GetWorkflowExecutionHistoryResponse DeserializeFromBlobToHistoryEvents(List<DataBlob> blobData, ByteBuffer nextPageToken) throws  TException {
  ...
  private GetWorkflowExecutionHistoryResponse getWorkflowExecutionHistory(
    ...
    try {
      ...
      return this.DeserializeFromBlobToHistoryEvents(result.getSuccess().rawHistory, result.getSuccess().nextPageToken);
